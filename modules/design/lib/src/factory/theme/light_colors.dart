...
class LightBackgroundPalette implements IBackgroundPalette {
  const LightBackgroundPalette();

  @override
  Gradient get gradientBackground => LinearGradient(
    colors: [const Color(0xFF2B2D42), const Color(0xffEBF8FF)],
    stops: [0.0, 1.0],
  );

  @override
  Color get solidBackground => const Color(0xFF2B2D42);
}

class LightForegroundColorPalette implements IForegroundColorPalette {
  const LightForegroundColorPalette();

  @override
  Color get active => const Color(0xff8793a7);

  @override
  Color get normal => const Color(0xff8793a7).withValues(alpha: 0.9);

  @override
  Color get minimal => const Color(0xff8793a7).withValues(alpha: 0.7);

  @override
  Color get disabled => const Color(0xff8793a7).withValues(alpha: 0.5);

  @override
  Color get detail => const Color(0xff8793a7).withValues(alpha: 0.25);

  @override
  Color get soft => const Color(0xff8793a7).withValues(alpha: 0.15);
}
...
class LightColorPalette implements IColorPalette {
  ...
  const LightColorPalette({
    this.backgroundPalette = const LightBackgroundPalette(),
    this.foreground = const LightForegroundColorPalette(),
