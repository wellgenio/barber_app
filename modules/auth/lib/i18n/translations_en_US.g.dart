...
class TranslationsEnUs implements Translations {
	...
	// Translations
	@override late final _TranslationsLoginPageEnUs loginPage = _TranslationsLoginPageEnUs._(_root);
}

// Path: loginPage
class _TranslationsLoginPageEnUs implements TranslationsLoginPagePtBr {
	_TranslationsLoginPageEnUs._(this._root);

	final TranslationsEnUs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Login';
	@override String get description => 'Please enter your credentials to log in.';
